...
const TwitterWalletButton: FC<
  {
    web3: ethers.providers.Web3Provider;
    setWeb3: Dispatch<SetStateAction<ethers.providers.Web3Provider>>;
    setBiconomy: Dispatch<SetStateAction<Biconomy>>;
    onClick?: CallableFunction;
  } & ButtonHTMLAttributes<HTMLButtonElement>
> = ({ web3, setWeb3, setBiconomy, onClick = () => null, ...props }) => {
  ...
  const connectWallet = async () => {
    ...
    if (!isLoggedIn)
      return (magic.oauth as OAuthExtension).loginWithRedirect({
        provider: 'twitter',
  ...
  return (
    <button onClick={web3 ? disconnectWallet : onClickConnect} {...props} />
  );
};
